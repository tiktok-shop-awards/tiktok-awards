/**
 * Feishu Auth Helper v17 - Feishu-only auth via SDK
 * Designed for Feishu in-app browser only (external browsers blocked by auth.js)
...
const FeishuAuthHelper = {
  ...
  async getUser() {
    ...
    // Step 3: SDK auth (Feishu in-app browser)
    try {
